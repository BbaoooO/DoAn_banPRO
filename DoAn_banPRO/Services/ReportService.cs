    ...
    public class ReportService
    {
        public void ExportLinhKienToCSV()
        {
            try
            {
                ...
                MessageBox.Show($"Xu?t báo cáo thành công t?i: {filePath}", "Thông báo", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show($"L?i xu?t báo cáo: {ex.Message}", "L?i", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
    }
}